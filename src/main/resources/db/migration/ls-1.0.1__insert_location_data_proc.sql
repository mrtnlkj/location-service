...
SET district_name_sk = polygon_district.name,
    ...
    region_name_sk   = polygon_region.name,
    region_name_en   = (polygon_region.tags::hstore OPERATOR(->) 'name:en'),
    state_name_sk    = polygon_state.name,
    state_name_en    = (polygon_state.tags::hstore OPERATOR(->) 'name:en'),
    is_in            = polygon_is_in.name FROM
    public.osm_polygon AS polygon_district,
    public.osm_polygon AS polygon_region,
